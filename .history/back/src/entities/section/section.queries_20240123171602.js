...
const getSectionByBlogIdQuery = "SELECT * FROM sections WHERE blogid = $1 ORDER BY structure ASC";

// post
const addSectionsQuery =
    "INSERT INTO sections (title, description, blogid, keyword, structure) VALUES ($1, $2, $3, $4, $5)";
