...
// filtros
const getBlogsByContinentQuery = "SELECT * FROM blogs WHERE continent = $1"
const getBlogsByCountryQuery = "SELECT * FROM blogs WHERE country = $1"
const getBlogsByDaysQuery = "SELECT * FROM blogs WHERE days = $1"

// const getFilterQuery =
//     "SELECT * FROM blogs WHERE continent = $1 AND country = $2 AND days = $3";
