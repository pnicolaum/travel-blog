...
export class BlogCreationComponent {
  ...
  postBlog() {
    ...
    if (this.title && this.keyword && this.continent && this.description && this.days && this.date) {
      ...
      this.mensaje = "Algunos campos son nulos o 0. No se puede enviar el blog.";
    }
  ...
  preventClose(event: Event) {
    event.stopPropagation(); // Evita que el modal se cierre al hacer clic dentro del contenido
  }
