  ...
  ngOnInit(): void {
    this.route.data.subscribe((data) => {
      ...
      this.sectionCreationService.getSectionByBlogid(this.sectionBlogid).subscribe(
        (response) => {
          // this.sectionBlogid = response[0].sectionBlogid;
          // this.sectionId = response[0].sectionId;
          // this.sectionTitle = response[0].sectionTitle;
          // this.sectionKeyword = response[0].sectionKeyword;
          // this.sectionDescription = response[0].sectionDescription;
          // this.sectionStructure = response[0].sectionStructure;
          this.sections = response.map((sectionItem: any) => ({
            sectionBlogid: sectionItem.sectionBlogid,
            sectionId: sectionItem.sectionId,
            sectionTitle: sectionItem.sectionTitle,
            sectionKeyword: sectionItem.sectionKeyword,
            sectionDescription: sectionItem.sectionDescription,
            sectionStructure: sectionItem.sectionStructure,
          }));
          console.log("aaaaaa");
