...
export class BlogDetailDisplayComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.data.subscribe((data) => {
      ...
      // Assign values to blog properties
      this.blog.title = data['blog'].title;
      this.blog.keyword = this.keyword;
      this.blog.continent = data['blog'].continent;
      this.blog.country = data['blog'].country;
      this.blog.description = data['blog'].description;
      this.blog.days = data['blog'].days;
      this.blog.date = data['blog'].date;
    });
