    ...
    this.route.data.subscribe((data) => {
      ...
      this.sectionCreationService.getSectionByBlogid(this.sectionBlogid).subscribe(
        (response) => {
          ...
          this.sections = response.map((response) => ({
            sectionBlogid: response.sectionBlogid,
            sectionId: response.sectionId,
            sectionTitle: response.sectionTitle,
            sectionKeyword: response.sectionKeyword,
            sectionDescription: response.sectionDescription,
            sectionStructure: response.sectionStructure,
          }));
